function fname_check()
  {
    ...
    if (fn_check) 
    {
        document.getElementById("errorfname").innerHTML="OK";
        return true;
    }
    else
    {
        document.getElementById("errorfname").innerHTML="First name should not contain numbers and symbols";
        return false;
    }
  }
  function lname_check()
  {
    ...
    if (fn_check) 
    {
        document.getElementById("errorlname").innerHTML="OK";
        return true;
    }
    else
    {
        document.getElementById("errorlname").innerHTML="Last name should not contain numbers and symbols";
        return false;
    }
  }
  ...
  function age_check()
  {
    ...
    if (age1.length<2) 
    {
        document.getElementById("errorage").innerHTML="Age must be more than 2 digits";
        return true;
    }
    else
    {
  ...
  function pass_check()
  {
    ...
    var pass_pattern = /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{8,20}$/;
...
function form_check()
{
    ...
    {
        document.getElementById("errorform").innerHTML="All fields are checked";
        return true;
    }
    else
    {
        document.getElementById("errorform").innerHTML="All fields are required";
        return false;
    }
}